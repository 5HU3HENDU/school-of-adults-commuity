...
st.header("Trusted Period Brands")
"""
...
- Yoga Poses: Balasana(Child Pose), Uttanasana(Forward bend), 
  Baddha Konasana, Shavasana.
"""

st.header("Apps For Tracking")
"""
...
st.header("Support & Awareness Groups")
"""
